#pragma checksum "C:\Users\olive\source\repos\Data_Binding\Data_Binding\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "023BF42B4953AF700DB1B17827743777"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Data_Binding
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj3_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::Data_Binding.Models.Book dataRoot;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::Data_Binding.Models.Book) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::Data_Binding.Models.Book)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::Data_Binding.Models.Book obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_CoverPage(obj.CoverPage, phase);
                        this.Update_Title(obj.Title, phase);
                        this.Update_Author(obj.Author, phase);
                    }
                }
            }
            private void Update_CoverPage(global::System.String obj, int phase)
            {
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::Data_Binding.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::Data_Binding.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::Data_Binding.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Books(global::System.Collections.Generic.List<global::Data_Binding.Models.Book> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
